...
void writeReg16Bit(uint8_t reg, uint16_t value){
  ...
  addr_i2c(g_i2cAddr, true);
  write_i2c(reg);
  write_i2c((value >> 8) & 0xFF);
  write_i2c((value     ) & 0xFF);
  close_i2c();
}
...
void writeReg32Bit(uint8_t reg, uint32_t value){
  ...
  addr_i2c(g_i2cAddr, true);
  write_i2c(reg);
  write_i2c((value >>24) & 0xFF);
  write_i2c((value >>16) & 0xFF);
  write_i2c((value >> 8) & 0xFF);
  write_i2c((value     ) & 0xFF);
  close_i2c();
}
...
uint32_t readReg32Bit(uint8_t reg) {
  ...
  addr_i2c(g_i2cAddr, false);
  read_ack_i2c(byte);
  value = (uint32_t) *byte << 24;
  read_ack_i2c(byte);
  value |= (uint32_t) *byte << 16;
  read_ack_i2c(byte);
  value |= (uint32_t) *byte << 8;
  read_nak_i2c(byte);
  value |= *byte;
  close_i2c();
  return value;
